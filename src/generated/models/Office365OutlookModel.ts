...
export type CalendarEventBackendShowAs =
  | "Free"
  | "Tentative"
  | "Busy"
  | "Oof"
  | "WorkingElsewhere"
  | "Unknown";
export type CalendarEventBackendType =
  | "SingleInstance"
  | "Occurrence"
  | "Exception"
  | "SeriesMaster";
...
export type RecurrencePatternType =
  ...
  | "AbsoluteYearly"
  | "RelativeYearly";
export type RecurrencePatternFirstDayOfWeek =
  | "Sunday"
  | "Monday"
  | "Tuesday"
  | "Wednesday"
  ...
  | "Friday"
  | "Saturday";
export type RecurrencePatternIndex =
  | "First"
  | "Second"
  | "Third"
  | "Fourth"
...
export type GraphCalendarEventClientReceiveresponseType =
  | "none"
  | "organizer"
  | "tentativelyAccepted"
  | "accepted"
  | "declined"
  | "notResponded";
export type GraphCalendarEventClientReceiveimportance =
  | "low"
  | "normal"
  | "high";
export type GraphCalendarEventClientReceiverecurrence =
  | "none"
  | "daily"
  | "weekly"
  | "monthly"
  | "yearly";
export type GraphCalendarEventClientReceiveshowAs =
  | "free"
  | "tentative"
  | "busy"
  | "oof"
  | "workingElsewhere"
  | "unknown";
export type GraphCalendarEventClientReceivesensitivity =
  | "normal"
  | "personal"
  | "private"
  | "confidential";
...
export type CalendarEventClientReceiveStringEnumsImportance =
  ...
  | "Normal"
  | "High";
export type CalendarEventClientReceiveStringEnumsResponseType =
  | "None"
  | "Organizer"
  | "TentativelyAccepted"
  | "Accepted"
  | "Declined"
  | "NotResponded";
export type CalendarEventClientReceiveStringEnumsRecurrence =
  | "None"
  | "Daily"
  | "Weekly"
  | "Monthly"
  | "Yearly";
export type CalendarEventClientReceiveStringEnumsShowAs =
  | "Free"
  | "Tentative"
  | "Busy"
  | "Oof"
...
export type ClientReceiveMessageStringEnumsImportance =
  | "Low"
  | "Normal"
  | "High";
...
export type AutomaticRepliesSettingClientStatus =
  | "Disabled"
  | "AlwaysEnabled"
  | "Scheduled";
export type AutomaticRepliesSettingClientExternalAudience =
  | "None"
  | "ContactsOnly"
  | "All";
...
export type SharedMailboxClientSendMessageImportance =
  | "Low"
  | "Normal"
  | "High";
...
export type SharedMailboxClientSendHtmlMessageImportance =
  | "Low"
  | "Normal"
  | "High";
...
export type CalendarEventClientTimeZone =
  | ""
...
export type CalendarEventClientRecurrence =
  | "None"
  | "Daily"
  | "Weekly"
  | "Monthly"
  | "Yearly";
export type CalendarEventClientShowAs =
  | "Free"
  | "Tentative"
  | "Busy"
  | "Oof"
...
export type CalendarEventHtmlClientTimeZone =
  | ""
  | "(UTC-12:00) International Date Line West"
  | "(UTC-11:00) Coordinated Universal Time-11"
  | "(UTC-10:00) Aleutian Islands"
...
export type CalendarEventHtmlClientRecurrence =
  | "None"
  | "Daily"
  | "Weekly"
  | "Monthly"
  | "Yearly";
export type CalendarEventHtmlClientShowAs =
  | "Free"
  | "Tentative"
  | "Busy"
  | "Oof"
...
export type GraphCalendarEventClientrecurrence =
  | "none"
  | "daily"
  | "weekly"
  | "monthly"
  | "yearly";
export type GraphCalendarEventClientshowAs =
  | "free"
  | "tentative"
  | "busy"
  | "oof"
  | "workingElsewhere"
  | "unknown";
export type GraphCalendarEventClientsensitivity =
  | "normal"
  | "personal"
  | "private"
  | "confidential";
...
export type GraphCalendarEventClientWithActionTypeActionType =
  | "added"
  | "updated"
  | "deleted";
export type GraphCalendarEventClientWithActionTyperesponseType =
  | "none"
  | "organizer"
  | "tentativelyAccepted"
  | "accepted"
  | "declined"
  | "notResponded";
export type GraphCalendarEventClientWithActionTypeimportance =
  | "low"
  | "normal"
  | "high";
export type GraphCalendarEventClientWithActionTyperecurrence =
  | "none"
  | "daily"
  | "weekly"
  | "monthly"
  | "yearly";
export type GraphCalendarEventClientWithActionTypeshowAs =
  | "free"
  | "tentative"
  | "busy"
  | "oof"
  | "workingElsewhere"
  | "unknown";
export type GraphCalendarEventClientWithActionTypesensitivity =
  | "normal"
  | "personal"
  | "private"
  | "confidential";
...
export const AutomaticRepliesSettingClient_V2status = {
  disabled: "disabled",
  alwaysEnabled: "alwaysEnabled",
  scheduled: "scheduled",
} as const;
export type AutomaticRepliesSettingClient_V2status =
  keyof typeof AutomaticRepliesSettingClient_V2status;
export const AutomaticRepliesSettingClient_V2externalAudience = {
  none: "none",
  contactsOnly: "contactsOnly",
  all: "all",
} as const;
export type AutomaticRepliesSettingClient_V2externalAudience =
  keyof typeof AutomaticRepliesSettingClient_V2externalAudience;
...
//   // Flag status
//   flag?:   export const UpdateEmailFlagflagStatus = {
//     flagged: 'flagged',
//     notFlagged: 'notFlagged',
//     complete: 'complete'
//   } as const;
//   export type UpdateEmailFlagflagStatus = keyof typeof UpdateEmailFlagflagStatus;
