...
export class Office365OutlookService {
   ...
   */
  public static async CalendarGetTable(
    table: string,
  ): Promise<IOperationResult<TableMetadata>> {
    const params: { table: string } = { table };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string },
      TableMetadata
    >({
      connectorOperation: {
   ...
   */
  public static async ContactGetTable(
    table: string,
  ): Promise<IOperationResult<TableMetadata>> {
    const params: { table: string } = { table };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async OnUpcomingEvents(
    table: string,
    lookAheadTimeInMinutes?: number,
  ): Promise<IOperationResult<CalendarEventList>> {
    const params: { table: string; lookAheadTimeInMinutes?: number } = {
      table,
      lookAheadTimeInMinutes,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; lookAheadTimeInMinutes?: number },
      CalendarEventList
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation triggers a flow when an upcoming calendar event is starting.
   */
  public static async OnUpcomingEventsV2(
    table: string,
    lookAheadTimeInMinutes?: number,
  ): Promise<IOperationResult<CalendarEventListClientReceive>> {
    const params: { table: string; lookAheadTimeInMinutes?: number } = {
      table,
      lookAheadTimeInMinutes,
    };
   ...
   * This operation triggers a flow when an upcoming calendar event is starting.
   */
  public static async OnUpcomingEventsV3(
    table: string,
    lookAheadTimeInMinutes?: number,
  ): Promise<IOperationResult<GraphCalendarEventListClientReceive>> {
    const params: { table: string; lookAheadTimeInMinutes?: number } = {
      table,
      lookAheadTimeInMinutes,
    };
   ...
   * Get calendar view of events.
   */
  public static async GetEventsCalendarView(
    calendarId: string,
    startDateTimeOffset: string,
    endDateTimeOffset: string,
  ): Promise<
    IOperationResult<PaginatedListResponse_CalendarEventClientReceiveStringEnums>
  > {
    const params: {
      calendarId: string;
      startDateTimeOffset: string;
      endDateTimeOffset: string;
    } = { calendarId, startDateTimeOffset, endDateTimeOffset };
    const result = await Office365OutlookService.client.executeAsync<
      {
        calendarId: string;
        startDateTimeOffset: string;
      ...
      PaginatedListResponse_CalendarEventClientReceiveStringEnums
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async CreateOnChangedEventPokeSubscription(
    ...
    const params: {
      ...
      incomingDays?: number;
      pastDays?: number;
    } = { subscription, table, incomingDays, pastDays };
    const result = await Office365OutlookService.client.executeAsync<
      {
        subscription: ClientSubscription;
        table: string;
   ...
   */
  public static async CreateGraphOnChangedEventPokeSubscription(
    subscription: ClientSubscription,
    table: string,
    incomingDays?: number,
    pastDays?: number,
   ...
   */
  public static async DeleteEventSubscription(
    id: string,
    options: string,
  ): Promise<IOperationResult<void>> {
   ...
   */
  public static async RenewEventSubscription(
    id: string,
    options: string,
    subscription: ClientSubscription,
  ): Promise<IOperationResult<void>> {
    ...
    const result = await Office365OutlookService.client.executeAsync<
      { id: string; options: string; subscription: ClientSubscription },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * When the file picker is opened for the first time.
   */
  public static async OnFilePickerOpen(
    operation: string,
    top?: number,
    skip?: number,
    mailboxAddress?: string,
  ): Promise<IOperationResult<EntityListResponse_FilePickerFile>> {
    const params: {
      operation: string;
      top?: number;
      skip?: number;
      mailboxAddress?: string;
    } = { operation, top, skip, mailboxAddress };
    const result = await Office365OutlookService.client.executeAsync<
      {
        operation: string;
        top?: number;
      ...
      EntityListResponse_FilePickerFile
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * When the file picker is open and being browsed.
   */
  public static async OnFilePickerBrowse(
    operation: string,
    id: string,
    top?: number,
    skip?: number,
    ...
    const params: {
      ...
      skip?: number;
      mailboxAddress?: string;
    } = { operation, id, top, skip, mailboxAddress };
    const result = await Office365OutlookService.client.executeAsync<
      {
        operation: string;
        id: string;
  ...
  public static async GetEmails(
    ...
    top?: number,
    skip?: number,
  ): Promise<IOperationResult<ClientReceiveMessageStringEnums[]>> {
    const params: {
      folderPath?: string;
      fetchOnlyUnread?: boolean;
      includeAttachments?: boolean;
  ...
  public static async SendEmail(
    emailMessage: ClientSendMessage,
  ): Promise<IOperationResult<void>> {
   ...
   */
  public static async GetOutlookCategoryNames(): Promise<
    IOperationResult<GraphOutlookCategory[]>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
   ...
   */
  public static async DraftEmail(
    draftMessage: ClientDraftHtmlMessage,
    messageId?: string,
    draftType?: string,
    comment?: string,
  ): Promise<IOperationResult<OutlookReceiveMessage>> {
    const params: {
      draftMessage: ClientDraftHtmlMessage;
      messageId?: string;
      draftType?: string;
      comment?: string;
    } = { draftMessage, messageId, draftType, comment };
    const result = await Office365OutlookService.client.executeAsync<
      {
        draftMessage: ClientDraftHtmlMessage;
        messageId?: string;
   ...
   */
  public static async UpdateDraftEmail(
    draftMessage: ClientDraftHtmlMessage,
    messageId: string,
  ): Promise<IOperationResult<void>> {
    const params: { draftMessage: ClientDraftHtmlMessage; messageId: string } =
      { draftMessage, messageId };
    const result = await Office365OutlookService.client.executeAsync<
      { draftMessage: ClientDraftHtmlMessage; messageId: string },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async SendDraftEmail(
    messageId: string,
  ): Promise<IOperationResult<void>> {
  ...
  public static async AssignCategory(
    ...
    const params: { messageId: string; category: string } = {
      messageId,
      category,
    };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async AssignCategoryBulk(
    messageIds: unknown,
    categoryName: string,
  ): Promise<IOperationResult<BatchOperationResult>> {
    const params: { messageIds: unknown; categoryName: string } = {
      messageIds,
      categoryName,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { messageIds: unknown; categoryName: string },
   ...
   * This operation gets emails from a folder.
   */
  public static async GetEmailsV2(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
    ...
    searchQuery?: string,
    top?: number,
  ): Promise<IOperationResult<BatchResponse_ClientReceiveMessage>> {
    const params: {
      folderPath?: string;
      to?: string;
      cc?: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      ...
      BatchResponse_ClientReceiveMessage
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation sends an email message.
   */
  public static async SendEmailV2(
    emailMessage: ClientSendHtmlMessage,
  ): Promise<IOperationResult<void>> {
  ...
  ): Promise<IOperationResult<ClientReceiveMessage>> {
    const params: {
      messageId: string;
      mailboxAddress?: string;
      includeAttachments?: boolean;
      internetMessageId?: string;
    } = { messageId, mailboxAddress, includeAttachments, internetMessageId };
    const result = await Office365OutlookService.client.executeAsync<
      {
        messageId: string;
        mailboxAddress?: string;
   ...
   */
  public static async DeleteEmail(
    messageId: string,
  ): Promise<IOperationResult<void>> {
    const params: { messageId: string } = { messageId };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   * This operation gets an email by id.
   */
  public static async GetEmailV2(
    messageId: string,
    mailboxAddress?: string,
    includeAttachments?: boolean,
    internetMessageId?: string,
  ...
  ): Promise<IOperationResult<GraphClientReceiveMessage>> {
    const params: {
      messageId: string;
      mailboxAddress?: string;
      includeAttachments?: boolean;
   ...
   */
  public static async GetEmailsV3(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
    ...
    searchQuery?: string,
    top?: number,
  ): Promise<IOperationResult<BatchResponse_GraphClientReceiveMessage>> {
    const params: {
      folderPath?: string;
      to?: string;
      cc?: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      ...
      BatchResponse_GraphClientReceiveMessage
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
  ...
  public static async Move(
    ...
    const params: { messageId: string; folderPath: string } = {
      messageId,
      folderPath,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { messageId: string; folderPath: string },
      ClientReceiveMessageStringEnums
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
  ...
  public static async MoveV2(
    ...
    const params: {
      ...
      folderPath: string;
      mailboxAddress?: string;
    } = { messageId, folderPath, mailboxAddress };
    const result = await Office365OutlookService.client.executeAsync<
      { messageId: string; folderPath: string; mailboxAddress?: string },
      GraphClientReceiveMessage
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async ReplyTo(
    messageId: string,
    comment: string,
    replyAll?: boolean,
  ): Promise<IOperationResult<void>> {
    const params: { messageId: string; comment: string; replyAll?: boolean } = {
      messageId,
      comment,
      replyAll,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { messageId: string; comment: string; replyAll?: boolean },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation replies to an email.
   */
  public static async ReplyToV2(
    messageId: string,
    replyParameters: ReplyMessage,
    mailboxAddress?: string,
  ): Promise<IOperationResult<void>> {
    const params: {
      messageId: string;
      replyParameters: ReplyMessage;
      mailboxAddress?: string;
    } = { messageId, replyParameters, mailboxAddress };
    const result = await Office365OutlookService.client.executeAsync<
      {
        messageId: string;
        replyParameters: ReplyMessage;
   ...
   * This operation replies to an email.
   */
  public static async ReplyToV3(
    messageId: string,
    replyParameters: ReplyHtmlMessage,
    mailboxAddress?: string,
  ): Promise<IOperationResult<void>> {
    const params: {
      messageId: string;
  ...
  public static async GetAttachment(
    ...
    const params: { messageId: string; attachmentId: string } = {
      messageId,
      attachmentId,
    };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async OnNewEmail(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
    ...
    includeAttachments?: boolean,
    subjectFilter?: string,
    x_ms_operation_context?: string,
  ): Promise<IOperationResult<TriggerBatchResponse_ClientReceiveMessage>> {
    const params: {
      folderPath?: string;
      to?: string;
      cc?: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      ...
      TriggerBatchResponse_ClientReceiveMessage
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation triggers a flow when a new email arrives. It will skip any email that has a total message size greater than the limit put by your Exchange Admin or 50 MB, whichever is less. It may also skip protected emails and emails with invalid body or attachments.
   */
  public static async OnNewEmailV2(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
    ...
    subjectFilter?: string,
    x_ms_operation_context?: string,
  ): Promise<IOperationResult<TriggerBatchResponse_GraphClientReceiveMessage>> {
    const params: {
      folderPath?: string;
      to?: string;
      cc?: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      ...
      TriggerBatchResponse_GraphClientReceiveMessage
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation triggers a flow when a new email arrives. It will skip any email that has a total message size greater than the limit put by your Exchange Admin or 50 MB, whichever is less. It may also skip protected emails and emails with invalid body or attachments.
   */
  public static async OnNewEmailV3(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
   ...
   */
  public static async OnFlaggedEmail(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
   ...
   * This operation triggers a flow when an email is flagged.
   */
  public static async OnFlaggedEmailV2(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
   ...
   * This operation triggers a flow when an email is flagged.
   */
  public static async OnFlaggedEmailV3(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
   ...
   * This operation triggers a flow when an email is flagged.
   */
  public static async OnFlaggedEmailV4(
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
   ...
   */
  public static async OnNewMentionMeEmail(
    messageIdToFireOnFirstTriggerRun?: string,
    folderPath?: string,
    to?: string,
    cc?: string,
    toOrCc?: string,
   ...
   * This operation triggers a flow when a new email mentioning me arrives. It will skip any email that has a total message size greater than the limit put by your Exchange Admin or 50 MB, whichever is less. It may also skip protected emails and emails with invalid body or attachments.
   */
  public static async OnNewMentionMeEmailV2(
    messageIdToFireOnFirstTriggerRun?: string,
    folderPath?: string,
    to?: string,
    cc?: string,
   ...
   * This operation triggers a flow when a new email mentioning me arrives. It will skip any email that has a total message size greater than the limit put by your Exchange Admin or 50 MB, whichever is less. It may also skip protected emails and emails with invalid body or attachments.
   */
  public static async OnNewMentionMeEmailV3(
    messageIdToFireOnFirstTriggerRun?: string,
    folderPath?: string,
    to?: string,
    cc?: string,
   ...
   */
  public static async SetAutomaticRepliesSetting(
    clientSetting: AutomaticRepliesSettingClient,
  ): Promise<IOperationResult<void>> {
    const params: { clientSetting: AutomaticRepliesSettingClient } = {
      clientSetting,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { clientSetting: AutomaticRepliesSettingClient },
   ...
   */
  public static async GetMailTips(
    mailboxAddress: string,
  ): Promise<IOperationResult<MailTipsClientReceive>> {
   ...
   */
  public static async GetSensitivityLabels(): Promise<
    IOperationResult<BatchResponse_SensitivityLabel>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
      BatchResponse_SensitivityLabel
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async CreateOnNewEmailSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    ...
    const params: {
      ...
      importance?: string;
      hasAttachment?: string;
    } = { subscription, folderPath, importance, hasAttachment };
    const result = await Office365OutlookService.client.executeAsync<
      {
        subscription: ClientSubscription;
        folderPath?: string;
   ...
   * Create a webhook subscription for the trigger when a new email arrives.
   */
  public static async CreateOnNewEmailPokeSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    fetchOnlyWithAttachment?: boolean,
    ...
    const params: {
      ...
      importance?: string;
      fetchOnlyWithAttachment?: boolean;
    } = { subscription, folderPath, importance, fetchOnlyWithAttachment };
    const result = await Office365OutlookService.client.executeAsync<
      {
        subscription: ClientSubscription;
        folderPath?: string;
   ...
   * Create a Graph webhook subscription for the trigger when a new email arrives.
   */
  public static async CreateGraphOnNewEmailPokeSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    fetchOnlyWithAttachment?: boolean,
   ...
   */
  public static async CreateOnNewMentionMeEmailPokeSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    fetchOnlyWithAttachment?: boolean,
   ...
   */
  public static async CreateGraphOnNewMentionMeEmailPokeSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    fetchOnlyWithAttachment?: boolean,
   ...
   * Create an Outlook webhook subscription for the trigger when an email is flagged.
   */
  public static async CreateOnFlaggedEmailPokeSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    fetchOnlyWithAttachment?: boolean,
   ...
   * Create a Graph webhook subscription for the trigger when an email is flagged.
   */
  public static async CreateGraphOnFlaggedEmailPokeSubscription(
    subscription: ClientSubscription,
    folderPath?: string,
    importance?: string,
    fetchOnlyWithAttachment?: boolean,
   ...
   */
  public static async DeleteOnNewEmailSubscription(
    id: string,
    options: string,
  ): Promise<IOperationResult<void>> {
    const params: { id: string; options: string } = { id, options };
   ...
   * Update web hook with renew interval.
   */
  public static async RenewOnNewEmailSubscription(
    id: string,
    options: string,
    subscription: ClientSubscription,
  ): Promise<IOperationResult<void>> {
   ...
   */
  public static async SendMailWithOptions(
    optionsEmailSubscription: OptionsEmailSubscription,
  ): Promise<IOperationResult<void>> {
    const params: { optionsEmailSubscription: OptionsEmailSubscription } = {
   ...
   */
  public static async SendApprovalMail(
    approvalEmailSubscription: ApprovalEmailSubscription,
  ): Promise<IOperationResult<void>> {
    const params: { approvalEmailSubscription: ApprovalEmailSubscription } = {
   ...
   */
  public static async DeleteApprovalMailSubscription(
    id: string,
  ): Promise<IOperationResult<void>> {
   ...
   */
  public static async DeleteOptionsMailSubscription(
    id: string,
  ): Promise<IOperationResult<void>> {
    const params: { id: string } = { id };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async SharedMailboxSendEmail(
    emailMessage: SharedMailboxClientSendMessage,
  ): Promise<IOperationResult<void>> {
    const params: { emailMessage: SharedMailboxClientSendMessage } = {
      emailMessage,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { emailMessage: SharedMailboxClientSendMessage },
   ...
   * This operation sends an email from a shared mailbox. Your account should have permission to access the mailbox for this operation to succeed.
   */
  public static async SharedMailboxSendEmailV2(
    emailMessage: SharedMailboxClientSendHtmlMessage,
  ): Promise<IOperationResult<void>> {
    const params: { emailMessage: SharedMailboxClientSendHtmlMessage } = {
      emailMessage,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { emailMessage: SharedMailboxClientSendHtmlMessage },
   ...
   */
  public static async SharedMailboxOnNewEmail(
    mailboxAddress: string,
    folderId?: string,
    to?: string,
    cc?: string,
   ...
   * This operation triggers a flow when a new email arrives in a shared mailbox. Your account should have permission to access the mailbox for this operation to succeed. It will skip any email that has a total message size greater than the limit put by your Exchange Admin or 50 MB, whichever is less. It may also skip protected emails and emails with invalid body or attachments.
   */
  public static async SharedMailboxOnNewEmailV2(
    mailboxAddress: string,
    folderId?: string,
    to?: string,
    cc?: string,
   ...
   */
  public static async CalendarGetTables(): Promise<
    IOperationResult<EntityListResponse_Table>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
      EntityListResponse_Table
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async CalendarGetItems(
    table: string,
    $orderby?: string,
    $top?: number,
    $skip?: number,
  ): Promise<IOperationResult<EntityListResponse_CalendarEventBackend>> {
    const params: {
      table: string;
      $orderby?: string;
      $top?: number;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; $orderby?: string; $top?: number; $skip?: number },
      EntityListResponse_CalendarEventBackend
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async CalendarPostItem(
    table: string,
    item: CalendarEventBackend,
  ): Promise<IOperationResult<CalendarEventBackend>> {
    const params: { table: string; item: CalendarEventBackend } = {
      table,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; item: CalendarEventBackend },
   ...
   */
  public static async CalendarGetItem(
    table: string,
    id: string,
  ): Promise<IOperationResult<CalendarEventBackend>> {
   ...
   */
  public static async CalendarDeleteItem(
    table: string,
    id: string,
  ): Promise<IOperationResult<void>> {
    const params: { table: string; id: string } = { table, id };
   ...
   */
  public static async CalendarPatchItem(
    table: string,
    id: string,
    item: CalendarEventBackend,
  ): Promise<IOperationResult<CalendarEventBackend>> {
    const params: { table: string; id: string; item: CalendarEventBackend } = {
      table,
      id,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; id: string; item: CalendarEventBackend },
      CalendarEventBackend
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async V3CalendarGetItems(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
   ...
   */
  public static async V3CalendarPostItem(
    table: string,
    item: CalendarEventHtmlClient,
  ): Promise<IOperationResult<CalendarEventClientReceiveStringEnums>> {
    const params: { table: string; item: CalendarEventHtmlClient } = {
      table,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; item: CalendarEventHtmlClient },
   ...
   */
  public static async V4CalendarGetItems(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
   ...
   * This operation creates a new event in a calendar.
   */
  public static async V4CalendarPostItem(
    table: string,
    item: GraphCalendarEventClient,
  ): Promise<IOperationResult<GraphCalendarEventClientReceive>> {
    const params: { table: string; item: GraphCalendarEventClient } = {
      table,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; item: GraphCalendarEventClient },
   ...
   */
  public static async V2CalendarGetItems(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
    ...
    IOperationResult<EntityListResponse_CalendarEventClientReceiveStringEnums>
  > {
    const params: {
      table: string;
      $filter?: string;
   ...
   */
  public static async V2CalendarPostItem(
    table: string,
    item: CalendarEventClient,
  ): Promise<IOperationResult<CalendarEventClientReceiveStringEnums>> {
    const params: { table: string; item: CalendarEventClient } = {
      table,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; item: CalendarEventClient },
      CalendarEventClientReceiveStringEnums
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async GetEventsCalendarViewV2(
    calendarId: string,
    startDateTimeOffset: string,
    endDateTimeOffset: string,
    $filter?: string,
   ...
   */
  public static async GetEventsCalendarViewV3(
    calendarId: string,
    ...
    IOperationResult<EntityListResponse_GraphCalendarEventClientReceive>
  > {
    const params: {
      calendarId: string;
      startDateTimeUtc: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      ...
      EntityListResponse_GraphCalendarEventClientReceive
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async V2CalendarGetItem(
    table: string,
    id: string,
  ): Promise<IOperationResult<CalendarEventClientReceiveStringEnums>> {
    const params: { table: string; id: string } = { table, id };
   ...
   */
  public static async V2CalendarPatchItem(
    table: string,
    id: string,
    item: CalendarEventClient,
  ): Promise<IOperationResult<CalendarEventClientReceiveStringEnums>> {
    const params: { table: string; id: string; item: CalendarEventClient } = {
      table,
      id,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; id: string; item: CalendarEventClient },
      CalendarEventClientReceiveStringEnums
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async V3CalendarGetItem(
    table: string,
    id: string,
  ): Promise<IOperationResult<GraphCalendarEventClientReceive>> {
    const params: { table: string; id: string } = { table, id };
   ...
   */
  public static async V3CalendarPatchItem(
    table: string,
    id: string,
    item: CalendarEventHtmlClient,
  ): Promise<IOperationResult<CalendarEventClientReceiveStringEnums>> {
    const params: { table: string; id: string; item: CalendarEventHtmlClient } =
      { table, id, item };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; id: string; item: CalendarEventHtmlClient },
      CalendarEventClientReceiveStringEnums
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async V4CalendarPatchItem(
    table: string,
    id: string,
    item: GraphCalendarEventClient,
  ): Promise<IOperationResult<GraphCalendarEventClientReceive>> {
    ...
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; id: string; item: GraphCalendarEventClient },
      GraphCalendarEventClientReceive
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async CalendarGetOnNewItems(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
    ...
    const params: {
      ...
      $skip?: number;
      x_ms_operation_context?: string;
    } = { table, $filter, $orderby, $top, $skip, x_ms_operation_context };
    const result = await Office365OutlookService.client.executeAsync<
      {
        table: string;
        $filter?: string;
   ...
   */
  public static async CalendarGetOnUpdatedItems(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
  ...
  public static async ODataStyleGetOnNewItems(
    ...
    const params: {
      ...
      $top?: number;
      $skip?: number;
    } = { dataset, table, $filter, $orderby, $top, $skip };
    const result = await Office365OutlookService.client.executeAsync<
      {
        dataset: string;
        table: string;
   ...
   */
  public static async ODataStyleCalendarGetOnUpdatedItems(
    dataset: string,
    table: string,
    $filter?: string,
    $orderby?: string,
   ...
   */
  public static async CalendarGetOnNewItemsV2(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
   ...
   */
  public static async CalendarGetOnNewItemsV3(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
   ...
   */
  public static async CalendarGetOnUpdatedItemsV2(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
   ...
   */
  public static async CalendarGetOnUpdatedItemsV3(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
   ...
   */
  public static async CalendarGetOnChangedItems(
    table: string,
    incomingDays?: number,
    pastDays?: number,
  ): Promise<IOperationResult<CalendarEventListWithActionType>> {
    const params: { table: string; incomingDays?: number; pastDays?: number } =
      { table, incomingDays, pastDays };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; incomingDays?: number; pastDays?: number },
   ...
   */
  public static async CalendarGetOnChangedItemsV2(
    table: string,
    incomingDays?: number,
    pastDays?: number,
  ): Promise<IOperationResult<GraphCalendarEventListWithActionType>> {
    const params: { table: string; incomingDays?: number; pastDays?: number } =
      { table, incomingDays, pastDays };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; incomingDays?: number; pastDays?: number },
   ...
   */
  public static async CalendarGetOnChangedItemsV3(
    table: string,
    incomingDays?: number,
    pastDays?: number,
  ): Promise<IOperationResult<GraphCalendarEventListWithActionType>> {
   ...
   */
  public static async ContactGetTables(): Promise<
    IOperationResult<EntityListResponse_Table>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
   ...
   */
  public static async ContactGetTablesV2(): Promise<
    IOperationResult<EntityListResponse_GraphContactFolder>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
      EntityListResponse_GraphContactFolder
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async ContactGetItems(
    table: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
    $skip?: number,
  ): Promise<IOperationResult<EntityListResponse_ContactResponse>> {
    const params: {
      table: string;
      $filter?: string;
      $orderby?: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      ...
      EntityListResponse_ContactResponse
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async ContactPostItem(
    table: string,
    item: Contact,
  ): Promise<IOperationResult<ContactResponse>> {
    const params: { table: string; item: Contact } = { table, item };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; item: Contact },
      ContactResponse
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async ContactGetItem(
    table: string,
    id: string,
  ): Promise<IOperationResult<ContactResponse>> {
    const params: { table: string; id: string } = { table, id };
   ...
   */
  public static async ContactDeleteItem(
    table: string,
    id: string,
  ): Promise<IOperationResult<void>> {
    const params: { table: string; id: string } = { table, id };
   ...
   */
  public static async ContactPatchItem(
    table: string,
    id: string,
    item: Contact,
  ): Promise<IOperationResult<ContactResponse>> {
    const params: { table: string; id: string; item: Contact } = {
      table,
      id,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { table: string; id: string; item: Contact },
      ContactResponse
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async ExportEmail(
    messageId: string,
  ): Promise<IOperationResult<string>> {
    const params: { messageId: string } = { messageId };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async ExportEmail_V2(
    messageId: string,
    mailboxAddress?: string,
  ): Promise<IOperationResult<string>> {
    const params: { messageId: string; mailboxAddress?: string } = {
      messageId,
      mailboxAddress,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { messageId: string; mailboxAddress?: string },
      string
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  // public static async Flag_V2(
  //   messageId: string,
  //   mailboxAddress?: string,
  //   body?: UpdateEmailFlag,
  // ): Promise<IOperationResult<void>> {
  //   const params: {
  //     messageId: string;
  //     mailboxAddress?: string;
  //     body?: UpdateEmailFlag;
  //   } = { messageId, mailboxAddress, body };
  //   const result = await Office365OutlookService.client.executeAsync<
  //     { messageId: string; mailboxAddress?: string; body?: UpdateEmailFlag },
  //     void
  //   >({
  //     connectorOperation: {
  //       tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async MarkAsRead_V2(
    messageId: string,
    mailboxAddress?: string,
   ...
   * This operation marks an email as read/unread.
   */
  public static async MarkAsRead_V3(
    messageId: string,
    mailboxAddress?: string,
    body?: Record<string, unknown>,
  ): Promise<IOperationResult<void>> {
   ...
   * This operation deletes an email by id.
   */
  public static async DeleteEmail_V2(
    messageId: string,
    mailboxAddress?: string,
  ): Promise<IOperationResult<void>> {
    const params: { messageId: string; mailboxAddress?: string } = {
   ...
   * This operation gets an email attachment by id.
   */
  public static async GetAttachment_V2(
    messageId: string,
    attachmentId: string,
    mailboxAddress?: string,
    extractSensitivityLabel?: boolean,
   ...
   * Respond to an event invite.
   */
  public static async RespondToEvent(
    event_id: string,
    response: string,
    body?: ResponseToEventInvite,
  ): Promise<IOperationResult<void>> {
    const params: {
      event_id: string;
      response: string;
    ...
    const result = await Office365OutlookService.client.executeAsync<
      { event_id: string; response: string; body?: ResponseToEventInvite },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * Respond to an event invite.
   */
  public static async RespondToEvent_V2(
    event_id: string,
    response: string,
    body?: ResponseToEventInvite,
  ): Promise<IOperationResult<void>> {
  ...
  public static async ForwardEmail(
    message_id: string,
    body: DirectForwardMessage,
  ): Promise<IOperationResult<void>> {
    const params: { message_id: string; body: DirectForwardMessage } = {
      message_id,
      body,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { message_id: string; body: DirectForwardMessage },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * Forward an email.
   */
  public static async ForwardEmail_V2(
    message_id: string,
    body: DirectForwardMessage,
    mailboxAddress?: string,
  ): Promise<IOperationResult<void>> {
    const params: {
      ...
      body: DirectForwardMessage;
      mailboxAddress?: string;
    } = { message_id, body, mailboxAddress };
    const result = await Office365OutlookService.client.executeAsync<
      {
        message_id: string;
        body: DirectForwardMessage;
   ...
   */
  public static async GetRoomLists(): Promise<
    IOperationResult<Record<string, unknown>>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
      Record<string, unknown>
   ...
   * Get all the room lists defined in the user's tenant
   */
  public static async GetRoomLists_V2(): Promise<
    IOperationResult<Record<string, unknown>>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
   ...
   */
  public static async GetRooms(): Promise<
    IOperationResult<Record<string, unknown>>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
   ...
   * Get all the meeting rooms defined in the user's tenant
   */
  public static async GetRooms_V2(): Promise<
    IOperationResult<Record<string, unknown>>
  > {
    const result = await Office365OutlookService.client.executeAsync<
      void,
   ...
   */
  public static async GetRoomsInRoomList(
    room_list: string,
  ): Promise<IOperationResult<Record<string, unknown>>> {
   ...
   * Get the meeting rooms in a specific room list
   */
  public static async GetRoomsInRoomList_V2(
    room_list: string,
  ): Promise<IOperationResult<Record<string, unknown>>> {
    const params: { room_list: string } = { room_list };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async FindMeetingTimes(
    body: Record<string, unknown>,
  ): Promise<IOperationResult<Record<string, unknown>>> {
   ...
   * Find meeting time suggestions based on organizer, attendee availability, and time or location constraints
   */
  public static async FindMeetingTimes_V2(
    body: Record<string, unknown>,
  ): Promise<IOperationResult<Record<string, unknown>>> {
    const params: { body: Record<string, unknown> } = { body };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   * Set the automatic replies setting for your mailbox.
   */
  public static async SetAutomaticRepliesSetting_V2(
    body: Record<string, unknown>,
  ): Promise<IOperationResult<Record<string, unknown>>> {
    const params: { body: Record<string, unknown> } = { body };
    const result = await Office365OutlookService.client.executeAsync<
   ...
   */
  public static async GetMailTips_V2(
    body: Record<string, unknown>,
  ): Promise<IOperationResult<{ value: MailTipsClientReceive_V2[] }>> {
    const params: { body: Record<string, unknown> } = { body };
    const result = await Office365OutlookService.client.executeAsync<
      { body: Record<string, unknown> },
      { value: MailTipsClientReceive_V2[] }
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation lists available calendars.
   */
  public static async CalendarGetTables_V2(
    skip?: number,
    top?: number,
    orderBy?: string,
  ): Promise<IOperationResult<Record<string, unknown>>> {
    const params: { skip?: number; top?: number; orderBy?: string } = {
      skip,
      top,
      orderBy,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { skip?: number; top?: number; orderBy?: string },
      Record<string, unknown>
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation deletes an event in a calendar.
   */
  public static async CalendarDeleteItem_V2(
    calendar: string,
    event: string,
  ): Promise<IOperationResult<void>> {
    const params: { calendar: string; event: string } = { calendar, event };
    const result = await Office365OutlookService.client.executeAsync<
      { calendar: string; event: string },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation gets a specific contact from a contacts folder.
   */
  public static async ContactGetItem_V2(
    folder: string,
    id: string,
  ): Promise<IOperationResult<ContactResponse_V2>> {
   ...
   * This operation deletes a contact from a contacts folder.
   */
  public static async ContactDeleteItem_V2(
    folder: string,
    id: string,
  ): Promise<IOperationResult<void>> {
    const params: { folder: string; id: string } = { folder, id };
   ...
   * This operation updates a contact in a contacts folder.
   */
  public static async ContactPatchItem_V2(
    folder: string,
    id: string,
    item: Contact_V2,
  ): Promise<IOperationResult<ContactResponse_V2>> {
    const params: { folder: string; id: string; item: Contact_V2 } = {
      folder,
      id,
      item,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { folder: string; id: string; item: Contact_V2 },
      ContactResponse_V2
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation gets contacts from a contacts folder.
   */
  public static async ContactGetItems_V2(
    folder: string,
    $filter?: string,
    $orderby?: string,
    $top?: number,
    $skip?: number,
  ): Promise<IOperationResult<EntityListResponse_ContactResponse_V2>> {
    const params: {
      folder: string;
      $filter?: string;
      $orderby?: string;
      $top?: number;
      $skip?: number;
    } = { folder, $filter, $orderby, $top, $skip };
    const result = await Office365OutlookService.client.executeAsync<
      {
        folder: string;
        $filter?: string;
      ...
      EntityListResponse_ContactResponse_V2
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation creates a new contact in a contacts folder.
   */
  public static async ContactPostItem_V2(
    folder: string,
    item: Contact_V2,
  ): Promise<IOperationResult<void>> {
    const params: { folder: string; item: Contact_V2 } = { folder, item };
    const result = await Office365OutlookService.client.executeAsync<
      { folder: string; item: Contact_V2 },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async UpdateMyContactPhoto(
    folder: string,
    id: string,
    body: string,
    Content_Type?: string,
    ...
    const params: {
      ...
      body: string;
      Content_Type?: string;
    } = { folder, id, body, Content_Type };
    const result = await Office365OutlookService.client.executeAsync<
      { folder: string; id: string; body: string; Content_Type?: string },
      void
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async mcp_EmailsManagement(
   ...
   */
  public static async mcp_MeetingManagement(
    queryRequest?: MCPQueryRequest,
    sessionId?: string,
  ): Promise<IOperationResult<MCPQueryResponse>> {
    const params: { queryRequest?: MCPQueryRequest; sessionId?: string } = {
   ...
   */
  public static async mcp_ContactsManagement(
    queryRequest?: MCPQueryRequest,
    sessionId?: string,
  ): Promise<IOperationResult<MCPQueryResponse>> {
    const params: { queryRequest?: MCPQueryRequest; sessionId?: string } = {
   ...
   */
  public static async ReceiveResponseGet(
    state: string,
    sig?: string,
    showConfirm?: boolean,
  ): Promise<IOperationResult<string>> {
    const params: { state: string; sig?: string; showConfirm?: boolean } = {
      state,
      sig,
      showConfirm,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { state: string; sig?: string; showConfirm?: boolean },
      string
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   * This operation gets a response from the user.
   */
  public static async ReceiveResponsePost(
    state: string,
    sig?: string,
    fromConfirm?: boolean,
  ): Promise<IOperationResult<string>> {
    const params: { state: string; sig?: string; fromConfirm?: boolean } = {
      state,
      sig,
      fromConfirm,
    };
    const result = await Office365OutlookService.client.executeAsync<
      { state: string; sig?: string; fromConfirm?: boolean },
      string
    >({
      connectorOperation: {
        tableName: Office365OutlookService.dataSourceName,
   ...
   */
  public static async ReceiveMailFromSubscription(
    state: string,
    subscriptionPayload: SubscriptionPayload_OutlookReceiveMessage,
    ...
    const params: {
      ...
      subscriptionPayload: SubscriptionPayload_OutlookReceiveMessage;
      validationtoken?: string;
    } = { state, subscriptionPayload, validationtoken };
    const result = await Office365OutlookService.client.executeAsync<
      {
        state: string;
        subscriptionPayload: SubscriptionPayload_OutlookReceiveMessage;
   ...
   * This operation validates the subscription request.
   */
  public static async ReceiveMailFromSubscriptionV2(
    state: string,
    subscriptionPayload: SubscriptionPayload_OutlookReceiveMessage,
    subscribedConnectionId: string,
    validationtoken?: string,
  ): Promise<IOperationResult<void>> {
    const params: {
      state: string;
      ...
      subscribedConnectionId: string;
      validationtoken?: string;
    } = { state, subscriptionPayload, subscribedConnectionId, validationtoken };
    const result = await Office365OutlookService.client.executeAsync<
      {
        state: string;
        subscriptionPayload: SubscriptionPayload_OutlookReceiveMessage;
   ...
   * This operation validates the subscription request.
   */
  public static async ReceiveEventFromSubscription(
    state: string,
    subscriptionPayload: SubscriptionPayload_SubscriptionEvent,
    validationtoken?: string,
  ): Promise<IOperationResult<void>> {
    const params: {
      state: string;
   ...
   * This operation validates the subscription request.
   */
  public static async ReceiveEventFromSubscriptionV2(
    state: string,
    subscriptionPayload: SubscriptionPayload_SubscriptionEvent,
    subscribedConnectionId: string,
    validationtoken?: string,
